      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-5 rounded-lg border border-grey-200 shadow-sm">
        <div>
          ...
          <p className="text-xs text-grey-600 mt-0.5">
            EnterpriseCEO Media Owners &amp; Executives Masterclass &bull; Target Class: 50 Executive Seats
          </p>
        </div>
        <div className="flex items-center gap-2.5">
          <button
            onClick={onExportCsv}
            className="inline-flex items-center text-xs font-semibold px-3 py-2 bg-grey-100 hover:bg-grey-200 text-navy-900 rounded-md transition-colors border border-grey-300"
          >
          ...
          <button
            ...
            className="inline-flex items-center text-xs font-bold px-3.5 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-md transition-colors shadow-sm"
          >
            Manage Applications
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-grey-500">Total Applications</span>
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs text-grey-500">submitted</span>
          </div>
        ...
        {/* Card 3: Invited / Confirmed */}
        <div 
          onClick={() => onNavigateToParticipants('invited')}
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-emerald-700">Invited / Seats Filled</span>
            <div className="w-8 h-8 rounded-md bg-emerald-50 flex items-center justify-center text-emerald-600">
              <CheckCircle2 className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-3xl font-bold text-emerald-900">{invited}</span>
            <span className="text-xs text-grey-500">of {target} seats</span>
          </div>
          {/* Progress bar */}
          <div className="mt-3">
            ...
            <div className="flex justify-between text-[10px] text-grey-500 mt-1 font-medium">
              <span>{capacityPct}% Capacity</span>
              <span>{Math.max(0, target - invited)} seats remaining</span>
            </div>
          </div>
        </div>
      </div>
