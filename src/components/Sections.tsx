...
import { Award, Video, Users, CheckCircle2 } from 'lucide-react';
...
export function BackgroundRationale() {
  return (
    <section className="py-20 md:py-24 px-6 md:px-12 bg-cream-50 overflow-hidden border-b border-navy-900/5">
      <motion.div {...scrollAnimation} className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-lg text-ink-900 leading-relaxed font-light">
          ...
          <div className="p-6 bg-white border-l-4 border-orange-500 shadow-sm my-8">
            <p className="font-bold text-xl text-navy-900 font-serif">
...
export function ProgrammeObjectives() {
  ...
  return (
    <section className="py-20 md:py-24 px-6 md:px-12 bg-white overflow-hidden">
      <motion.div {...scrollAnimation} className="max-w-4xl mx-auto">
...
export function TargetAudience() {
  ...
  return (
    <section id="who-its-for" className="py-20 md:py-24 px-6 md:px-12 bg-grey-100 overflow-hidden border-t border-grey-200">
      <motion.div {...scrollAnimation} className="max-w-5xl mx-auto">
...
export function ProgrammeStructure() {
  return (
    <section id="structure" className="py-20 md:py-24 px-6 md:px-12 bg-white overflow-hidden">
      <motion.div {...scrollAnimation} className="max-w-5xl mx-auto">
        ...
        {/* Day 3 Immersion Add-on */}
        <div className="border-2 border-blue-500/30 bg-blue-50/30 p-8 md:p-10 relative overflow-hidden mb-14">
          <div className="bg-blue-600 text-white px-4 py-1.5 inline-block mb-5 uppercase tracking-wider text-xs font-bold">
            Optional Add-on
          </div>
          <h3 className="text-2xl md:text-3xl font-serif text-navy-900 mb-4">
            Day 3: Executive Media &amp; Tech Immersion Experience
          </h3>
          <p className="text-base md:text-lg text-ink-900 leading-relaxed mb-6">
            An exclusive, hands-on immersion within leading technology organisations such as <strong>Moniepoint, Google, or Meta</strong>. This immersion provides a rare opportunity to move beyond theory, enabling participants to engage directly with the systems, people, and processes driving global technology success.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            {[
              'Guided tours of innovation hubs and operational environments',
              'Interactive sessions with tech executives and product teams',
              'Deep dives into digital transformation, fintech, and platform ecosystems',
              'Exposure to scalable technology models and growth strategies',
              'Networking opportunities with industry professionals'
            ].map((item, i) => (
              <div key={i} className="flex items-start gap-2.5">
                <span className="w-2 h-2 bg-blue-600 mt-2 shrink-0 rounded-full"></span>
                <span className="text-sm md:text-base text-ink-900">{item}</span>
              </div>
            ))}
          </div>
        </div>
