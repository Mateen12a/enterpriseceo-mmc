...
export function LogisticsParticipation() {
  ...
  return (
    <section id="logistics" className="py-20 md:py-24 px-6 md:px-12 bg-blue-600 text-white relative overflow-hidden">
      <motion.div {...scrollAnimation} className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4 max-w-2xl mx-auto mb-12">
          {[
            ...
            { label: 'Duration', value: '2-day core programme, plus optional 3rd-day immersion' },
            { label: 'Participants', value: '50 carefully selected senior media executives' },
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-white/80 mt-3 flex items-center justify-center gap-1.5">
            ...
            Strictly limited to 50 vetted participants for executive depth
          </p>
        </div>
      </motion.div>
    </section>
...
export function Sponsorship() {
  return (
    <section id="sponsorship" className="bg-white">
      <div className="bg-orange-600 text-white py-16 md:py-20 px-6 md:px-12 text-center relative overflow-hidden">
      ...
      <motion.div {...scrollAnimation} className="py-16 md:py-20 px-6 md:px-12 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-grey-100/50 p-8 border border-grey-200 flex flex-col justify-between">
          <div>
            ...
            <ul className="space-y-4 mb-8">
              {[
                'Direct access to 50+ senior media executives and decision-makers',
...
export function Conclusion() {
  ...
  return (
    <section className="py-24 md:py-28 px-6 md:px-12 bg-navy-900 text-center relative overflow-hidden border-t border-white/10">
      <motion.div {...scrollAnimation} className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="max-w-xl mx-auto p-8 bg-white/5 border border-white/10 rounded-lg backdrop-blur-sm">
          <h3 className="text-xl md:text-2xl font-serif text-white mb-2">
            Secure Your Seat in the 2026 Cohort
          </h3>
          <p className="text-sm text-cream-50/70 mb-6">
            21–22 October 2026 • Strictly Limited to 50 Selected Media Leaders
          </p>
          <button
            onClick={openApplyModal}
            className="bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-bold text-base px-8 py-4 rounded-md shadow-xl transition-all inline-flex items-center gap-2"
